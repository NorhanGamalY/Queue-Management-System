        ...
        <div key={data.month} className="flex items-center">
          ...
          <div className="flex-1">
            <div className="bg-gray-200 rounded-full h-8 relative overflow-hidden">
              <div
                className="bg-gradient-to-r from-green-400 to-[#359487] dark:from-green-600 dark:to-[#b4f221] h-full rounded-full flex items-center justify-end pr-3 transition-all duration-1000 ease-out"
          ...
          <div className="w-32 text-right text-sm font-semibold text-gray-900 ml-4">
